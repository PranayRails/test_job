...
RSpec.describe TrainOperator, type: :model do
  before(:example) do
    ...
    @train = Train.new(name: "Parcel Owner", source: 'source 1', destination: 'dest 2', weight_capacity: 200, volume_capacity: 10000, status: 'Available', cost: 200, train_operator_id: @trains_operator.id)
  end
